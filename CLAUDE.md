...
- **Strict TDD is mandatory**: Write failing test first (tests-as-documentation, one-at-a-time) -> minimal code to pass -> refactor -> linting. TDD-Guard hooks block edits if tests fail.
