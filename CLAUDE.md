...
- **Strict TDD is mandatory**: Write failing test first (test-as-documentation, one-at-a-time) -> minimal code to pass -> refactor -> linting. TDD-Guard hooks block edits if tests fail.
